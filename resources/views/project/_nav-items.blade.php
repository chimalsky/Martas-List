<a href="@route('project.index')" class="font-semibold block px-4 py-2 leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900">
    Home
</a>
...
<a href="@route('project.digital-objects.index')" class="italic block px-4 py-2 leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900">
    <img src="{{ asset('img/map-ma.png') }}" class="w-8 h-8 rounded-full object-cover inline-block" /> 
    <span>Map</span>
</a>
<a href="@route('project.digital-objects.index')" class="italic block px-4 py-2 leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900">
    <img src="{{ asset('img/do-2.jpg') }}" class="w-8 h-8 rounded-full object-cover inline-block" /> 
    <span>Timeline</span>
</a>
<a href="@route('project.digital-objects.index')" class="italic block px-4 py-2 leading-5 text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900">
