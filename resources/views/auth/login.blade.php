        ...
        <div class="flex flex-wrap justify-center">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 rounded shadow-md">
                    ...
                    <div class="font-bold text-gray-700 py-3 px-6 mb-0">
                        {{ __('Login') }}
                    </div>
                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="email" class="block text-gray-500 text-xl font-bold mb-2">
                                {{ __('E-Mail Address') }}:
                            </label>
                            ...
                            @if ($errors->has('email'))
                                <p class="bg-red-200 italic mt-2 p-1">
                                    {{ $errors->first('email') }}
                                </p>
                            @endif
                        </div>
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="password" class="block text-gray-500 text-xl font-bold mb-2">
                                {{ __('Password') }}:
                            </label>
                        ...
                        <div class="flex mb-6">
                            ...
                            <label class="text-sm text-gray-700 ml-3 cursor-pointer" for="remember">
                                {{ __('Remember Me') }}
                            </label>
                        </div>
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            @if (Route::has('password.request'))
                                <a class="text-sm text-blue-700 hover:text-blue-900 whitespace-no-wrap no-underline ml-auto" href="{{ route('password.request') }}">
                                    {{ __('Forgot Your Password?') }}
                                </a>
                            @endif

                            @if (Route::has('register'))
                                <p class="w-full text-center text-gray-700 mt-16 -mb-4">
